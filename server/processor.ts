...
const RESPONSE_SCHEMA: Schema = {
  ...
  properties: {
    assigned: {
      type: Type.BOOLEAN,
      description:
        "True if the provided 'ekipName' is found within the ekip/staff section of the raw data (usually inside parentheses at the end).",
    },
    Raw_data: {
      type: Type.STRING,
    ...
    data: {
      ...
      properties: {
        ...
        type_of_show: {
          type: Type.STRING,
          description:
            "The calculated service details based on the role rules (e.g., '1 MAKE + 2 DẶM' or '2 PS').",
        },
      },
